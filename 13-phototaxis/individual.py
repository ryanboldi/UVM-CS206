...
class INDIVIDUAL:
    def __init__(self, i):
        self.ID = i
        self.genome = np.random.rand(8,5) *2 -1
        self.fitness = 0
    ...
    def Compute_Fitness(self):
        ...
        light = self.sim.get_sensor_data(sensor_id=self.robot.L4)

        self.fitness += light[-1] #gets last element in light array (last light pos)
        del self.sim
